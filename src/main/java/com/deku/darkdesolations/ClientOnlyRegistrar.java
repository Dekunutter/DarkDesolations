...
import com.deku.darkdesolations.client.renderers.*;
...
public class ClientOnlyRegistrar {
    ...
    public static class ClientRegistryEvents {
        ...
        public static void onEntityRendererRegistry(final EntityRenderersEvent.RegisterRenderers registerEntityEvent) {
            registerEntityEvent.registerEntityRenderer(ModEntityTypeInitializer.CORALFFISH_ENTITY_TYPE.get(), CoralfishRenderer::new);
        }
        ...
        public static void onEntityRendererRegistry(final EntityRenderersEvent.RegisterLayerDefinitions registerLayerDefinitionEvent) {
            //registerLayerDefinitionEvent.registerLayerDefinition(ModModelLayerLocations.CORALFISH, () -> ModLayerDefinitions.CORALFISH_LAYER);
        }
