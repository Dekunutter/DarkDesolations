...
public class LandTreeCoralFeature extends LandCoralFeature {
    public LandTreeCoralFeature() {
     ...
     * NOTE AGAIN: This is incredibly similar to DeadTreeCoralFeature but since we are inheriting from a pretty static vanilla coral feature and I want to attach different generation capabilities to underwater vs land coral, I have essentially duplicated features
     *
