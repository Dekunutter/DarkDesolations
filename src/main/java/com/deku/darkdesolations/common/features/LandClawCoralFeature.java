...
public class LandClawCoralFeature extends LandCoralFeature {
    public LandClawCoralFeature() {
     ...
     *
     * NOTE: Pretty much just a copy of how vanilla generates a claw coral feature in warm oceans, but with minor changes to only apply on land
     * NOTE AGAIN: This is incredibly similar to DeadClawCoralFeature but since we are inheriting from a pretty static vanilla coral feature and I want to attach different generation capabilities to underwater vs land coral, I have essentially duplicated features
     *
